...
<body>
    ...
    <td>{{$v->price}}</td>
        @if($v->state==1)
            <td>正常</td>
            <td><button act="down" name="modify" gid="{{$v->id}}">下架</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button act="delete" name="delete" did="{{$v->id}}">删除</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button act="modify" name="modifytrue" mid="{{$v->id}}">修改</button></td>
        @else
            <td>下架</td>
            <td><button act="up" name="modify" gid="{{$v->id}}">上架</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button act="delete" name="delete" did="{{$v->id}}">删除</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button act="modify" name="modifytrue" mid="{{$v->id}}">修改</button></td>
        @endif
    </tr>
    @endforeach
    </tbody>
