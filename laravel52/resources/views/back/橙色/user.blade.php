...
<body>
    ...
    <td>{{date('Y-m-d H:i:s',$v->create_time)}}</td>
        ...
        @else
            <td>禁用</td>
            <td><button act="up" name="modify" gid="{{$v->id}}">禁用</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button act="delete" name="delete" did="{{$v->id}}">删除</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button act="modify" name="modifytrue" mid="{{$v->id}}">修改</button></td>
        @endif
    </tr>
    @endforeach
    </tbody>
